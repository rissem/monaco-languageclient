...
function isRangeReplace(
  v: Partial<monaco.IRange> | RangeReplace
): v is RangeReplace {
...
export class MonacoToProtocolConverter {
  ...
  asCompletionTriggerKind(
    ...
    switch (triggerKind) {
      ...
      case this._monaco.languages.CompletionTriggerKind
...
export class ProtocolToMonacoConverter {
  ...
  asResourceEdits(
    ...
    return edits.map((edit) => ({
      ...
      modelVersionId,
      metadata: AnnotatedTextEdit.is(edit)
  ...
  asWorkspaceEdit(
    ...
    if (item.changeAnnotations !== undefined) {
      for (const key of Object.keys(item.changeAnnotations)) {
        const metaData = this.asWorkspaceEditMetadata(
    ...
    const edits: (
      | monaco.languages.WorkspaceTextEdit
      | monaco.languages.WorkspaceFileEdit
    )[] = [];
    if (item.documentChanges) {
      ...
      for (const key of Object.keys(item.changes)) {
        ...
        edits.push(
          ...this.asResourceEdits(resource, item.changes[key], asMetadata)
        );
      }
    }
    return {
  ...
  ): monaco.languages.CodeLens | undefined;
  asCodeLens(
    item: CodeLens | undefined | null
  ): monaco.languages.CodeLens | undefined {
    if (!item) {
  ...
  asSymbolInformations(
    ...
    return values.map((information) =>
      this.asSymbolInformation(information, uri)
    );
  }
  ...
  asCompletionResult(
    ...
    if (Array.isArray(result)) {
      const suggestions = result.map((item) =>
        this.asCompletionItem(item, defaultRange)
      );
      return {
        incomplete: false,
        suggestions,
  ...
  asCompletionItemKind(
    ...
    if (
      ...
      value <= CompletionItemKind.TypeParameter
    ) {
      switch (value) {
        ...
        case CompletionItemKind.Function:
          return [
            this._monaco.languages.CompletionItemKind.Function,
            undefined,
          ];
        case CompletionItemKind.Constructor:
          return [
            this._monaco.languages.CompletionItemKind.Constructor,
            undefined,
          ];
        ...
        case CompletionItemKind.Variable:
          return [
            this._monaco.languages.CompletionItemKind.Variable,
            undefined,
          ];
        ...
        case CompletionItemKind.Interface:
          return [
            this._monaco.languages.CompletionItemKind.Interface,
            undefined,
          ];
        ...
        case CompletionItemKind.Property:
          return [
            this._monaco.languages.CompletionItemKind.Property,
            undefined,
          ];
        ...
        case CompletionItemKind.Reference:
          return [
            this._monaco.languages.CompletionItemKind.Reference,
            undefined,
          ];
        ...
        case CompletionItemKind.EnumMember:
          return [
            this._monaco.languages.CompletionItemKind.EnumMember,
            undefined,
          ];
        case CompletionItemKind.Constant:
          return [
            this._monaco.languages.CompletionItemKind.Constant,
            undefined,
          ];
        ...
        case CompletionItemKind.Operator:
          return [
            this._monaco.languages.CompletionItemKind.Operator,
            undefined,
          ];
        case CompletionItemKind.TypeParameter:
          return [
            this._monaco.languages.CompletionItemKind.TypeParameter,
            undefined,
          ];
        default:
